...
static const char *const autostart[] = {
    "dunst", "&", NULL, 
    "swaybg", "-i", "/home/kun/Pictures/Wallpapers/wall2.jpg", NULL,
...
static const struct xkb_rule_names xkb_rules = {
    .model = "pc105",
    .layout = "us,th", // Replace with your language codes (e.g., us and th for Thai)
    .options = "grp:alt_shift_toggle", // Or another toggle like "grp:win_space_toggle"
};
...
#define TAGKEYS(KEY, TAG)                                                      \
  {MODKEY, KEY, view, {.ui = 1 << TAG}},                                       \
    ...
    MODKEY | WLR_MODIFIER_CTRL | WLR_MODIFIER_SHIFT, KEY, toggletag, {         \
      .ui = 1 << TAG                                                           \
    }                                                                          \
  }
...
"wmenu-run", 
"-f", "MartianMono Nerd Font 16",
"-l" "10",
NULL
};

// screenshot
static const char *screenshotfull[] = {"/home/kun/.config/dwl/scripts/screenshot.sh", "full", NULL};
static const char *screenshotarea[] = {"/home/kun/.config/dwl/scripts/screenshot.sh", "area", NULL};

// volume
static const char *volup[] = {"/home/kun/.config/dwl/scripts/volume.sh", "up", NULL};
static const char *voldown[] = {"/home/kun/.config/dwl/scripts/volume.sh", "down", NULL};
static const char *volmute[] = {"/home/kun/.config/dwl/scripts/volume.sh", "mute", NULL};
...
static const Key keys[] = {
    ...
    //brightness
    { 0, XKB_KEY_XF86MonBrightnessUp,   spawn, {.v = brighup} },
    { 0, XKB_KEY_XF86MonBrightnessDown, spawn, {.v = brighdown} },
